...
{
    mysql_query("UPDATE `users` SET  `latitude` = '".$_GET['lat']."' , `longitude` = '".$_GET['lng']."' WHERE `group_id`='".$_GET['groupid']."' AND `name` = '".$_GET['name']."' ");
    $query = "SELECT * FROM `users` where group_id = '".$_GET['groupid']."' ";
    $to_encode = array(); 
